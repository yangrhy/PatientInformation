...
namespace HealthRecords.PatientsInfoDataSetTableAdapters {
...
SELECT [Patient ID], [First Name], [Last Name], [Birth Date], Age, Address, City, State, [Zip Code], [Phone Number], BMI, [Maximum Heart Rate], [Target Heart Rate Range] FROM [Table] WHERE ([Patient ID] = @Patient_ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::HealthRecords.Properties.Settings.Default.PatientsInfoConnectionString;
        }
